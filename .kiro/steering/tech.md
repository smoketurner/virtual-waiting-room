...
| Bot & abuse mitigation | Seal-time demotion over the join telemetry (ADR-0029, #145): operator `signal:max` rules, compact tail, `observe` by default. WAF: Bot Control, ASN matching, anti-DDoS in Count mode — **not built** (N7, #59, #70) |
